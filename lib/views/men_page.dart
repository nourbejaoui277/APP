...
class _MenPageState extends State<MenPage> with SingleTickerProviderStateMixin {
  ...
  Widget _buildSampleProducts(int subcategoryId) {
    ...
    final sampleProducts = [
      Product(
        id: 'm_${subcategoryId}_1',
        name: 'Men’s $subcategoryName Item 1',
        price: 49.99 + subcategoryId * 10,
        stock: 20,
        sectionId: 1,
        categoryId: subcategoryId,
        boutiqueId: subcategoryId % 3 + 1,
        description: 'Premium $subcategoryName',
      ),
      Product(
        id: 'm_${subcategoryId}_2',
        name: 'Men’s $subcategoryName Item 2',
  ...
  Widget _buildProductCard(Product product) {
    return Padding(
      ...
      child: SizedBox(
        height: 250, // Total height of the card
        width: 180,
        child: Material(
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: const DecorationImage(
                        image: AssetImage('assets/images/men_default.jpg'),
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
                            ...
                            IconButton(
                              ...
                              onPressed: () {
                                final cartItem = CartItem(
                                  ...
                                  price:
                                      'TND ${product.price.toStringAsFixed(2)}',
                                  image: 'assets/images/men_default.jpg',
                                );
