  ...
  Widget _buildCategories(BuildContext context) {
    return Container(
      ...
      child: ListView(
        ...
        children: [
          _buildCategoryCard(
              'T-Shirts', 'assets/images/Accessories_tshirt.jpg', context),
          _buildCategoryCard(
              'Jeans', 'assets/images/Accessories_jeans.jpg', context),
          _buildCategoryCard(
              'Jackets', 'assets/images/Accessories_jacket.jpg', context),
          _buildCategoryCard(
              'Shoes', 'assets/images/Accessories_shoes.jpg', context),
          _buildCategoryCard('Accessories',
              'assets/images/Accessories_accessories.jpg', context),
        ],
      ),
    );
  }
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          ...
          MaterialPageRoute(
              builder: (context) =>
                  AccessoriesPage()), // Or navigate to a specific category page
        );
      },
      child: Card(
