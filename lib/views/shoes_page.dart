  ...
  Widget _buildCategories(BuildContext context) {
    return Container(
      ...
      child: ListView(
        ...
        children: [
          _buildCategoryCard(
              'T-Shirts', 'assets/images/Shoes_tshirt.jpg', context),
          _buildCategoryCard('Jeans', 'assets/images/Shoes_jeans.jpg', context),
          _buildCategoryCard(
              'Jackets', 'assets/images/Shoes_jacket.jpg', context),
          _buildCategoryCard('Shoes', 'assets/images/Shoes_shoes.jpg', context),
          _buildCategoryCard(
              'Accessories', 'assets/images/Shoes_accessories.jpg', context),
        ],
      ),
    );
  }
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          ...
          MaterialPageRoute(
              builder: (context) =>
                  ShoesPage()), // Or navigate to a specific category page
        );
      },
      child: Card(
