  ...
  Widget _buildCategories(BuildContext context) {
    return Container(
      ...
      child: ListView(
        ...
        children: [
          _buildCategoryCard(
              'T-Shirts', 'assets/images/Kids_tshirt.jpg', context),
          _buildCategoryCard('Jeans', 'assets/images/Kids_jeans.jpg', context),
          _buildCategoryCard(
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          ...
          MaterialPageRoute(
              builder: (context) =>
                  ElectronicsPage()), // Or navigate to a specific category page
        );
      },
      child: Card(
