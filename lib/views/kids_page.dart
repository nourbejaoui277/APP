...
class _KidsPageState extends State<KidsPage>
  ...
  Widget _buildSampleProducts(int subcategoryId) {
    ...
    final sampleProducts = [
      Product(
        id: 'k_${subcategoryId}_1',
        name: 'Kids’ $subcategoryName Item 1',
        price: 29.99 + subcategoryId * 8,
        stock: 25,
        sectionId: 3,
        categoryId: subcategoryId,
        boutiqueId: subcategoryId % 3 + 1,
        description: 'Fun $subcategoryName',
      ),
      Product(
        id: 'k_${subcategoryId}_2',
        name: 'Kids’ $subcategoryName Item 2',
        price: 39.99 + subcategoryId * 8,
        stock: 20,
        sectionId: 3,
        categoryId: subcategoryId,
        boutiqueId: subcategoryId % 3 + 1,
        description: 'Comfy $subcategoryName',
      ),
    ];
  ...
  Widget _buildProductCard(Product product) {
    return Padding(
      ...
      child: SizedBox(
        height: 250, // Controls the full height of the card
        width: 180,
        child: Material(
            ...
            child: Card(
              ...
              child: Column(
                ...
                children: [
                  // Image section
                  Container(
                    height: 120, // slightly reduced to avoid overflow
                    width: double.infinity,
                    decoration: BoxDecoration(
                      borderRadius:
                          const BorderRadius.vertical(top: Radius.circular(15)),
                      image: const DecorationImage(
                        image: AssetImage('assets/images/kids_default.jpg'),
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
                            ...
                            IconButton(
                              ...
                              onPressed: () {
                                final cartItem = CartItem(
                                  ...
                                  price:
                                      'TND ${product.price.toStringAsFixed(2)}',
                                  image: 'assets/images/kids_default.jpg',
                                );
